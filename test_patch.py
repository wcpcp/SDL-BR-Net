...
from tester_patch import Tester
...
def main(data_path, weight_path, CFG, show):
    ...
    test_loader = DataLoader(test_dataset, 4, shuffle=False,  num_workers=16, pin_memory=True)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-dp", "--dataset_path", default="/root/FR-UNet-master/dataset/DRIVE", type=str,
                        help="the path of dataset")
    parser.add_argument("-wp", "--wetght_path", default="/root/FR-UNet-master/saved/DcomNet/240426231237/checkpoint-epoch96.pth", type=str,
