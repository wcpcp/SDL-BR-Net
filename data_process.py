...
def data_process(data_path, name, patch_size, stride, mode):
    ...
    if mode == "test":
        ...
        if name != "CHUAC":
            ...
            cgt_list = get_square(cgt_list, name)
        ...
        save_each_image(cgt_list, save_path, "cgt", name)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-dn', '--dataset_name', default="DRIVE", type=str,
                        help='the name of dataset',choices=['DRIVE','CHASEDB1','STARE','CHUAC','DCA1'],required=False)
